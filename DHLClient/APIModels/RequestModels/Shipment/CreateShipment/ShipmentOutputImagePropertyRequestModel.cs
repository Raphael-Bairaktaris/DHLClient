...
namespace DHLClient
{
    ...
    public class ShipmentOutputImagePropertyRequestModel
    {
        ...
        public IEnumerable<CustomerBarcodeRequestModel>? CustomerBarcodes { get; set; }

        /// <summary>
        /// Customer Logo Image to be printed on transport label
        /// </summary>
        [JsonProperty("customerLogos")]
        public IEnumerable<CustomerLogoRequestModel>? CustomerLogos { get; set; }
        ...
        public bool? ShouldSplitTransportAndWaybillDocLabels { get; set; }

        /// <summary>
        /// When set to true it will generate a single PDF or thermal output image file consists of Transport Label, Waybill Document, 
        /// Shipment Receipt and Commercial Invoice. The default value is false, where a single PDF or thermal output image file consists 
        ...
        public bool? ShouldPrintAllDocumentsInOneImage { get; set; }
        ...
        public bool? ShouldSplitDocumentsByPages { get; set; }
        ...
        public bool? ShouldSplitInvoiceAndReceipt { get; set; }
        ...
        public bool? ShouldPrintReceiptAndLabelsInOneImage { get; set; }
